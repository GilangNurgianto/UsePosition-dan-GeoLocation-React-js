...
import { geolocated, geoPropTypes } from "./Location";
...
const Demo = props => (
    ...
    >
        {!props.isGeolocationAvailable ? (
            <div>Browser kamu tidak support Geolocation.</div>
        ) : !props.isGeolocationEnabled ? (
            <div>Geolocation tidak aktif.</div>
        ) : props.coords ? (
            <div>
                Kamu di koordinat{" "}
                ...
                .
                        ...
                        <div>Mengambil data koordinat&hellip;</div>
                    )}
        {!!props.positionError && (
            <div>
                <br />
                koordinat terakhir error:
